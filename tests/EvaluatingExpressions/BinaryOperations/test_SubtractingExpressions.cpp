...
TEST(InterpreterTest, SubtractsPositiveNumbers) {
  ...
  Binary* expr1 =
      new Binary(new Literal(100), Token(TokenType::MINUS), new Literal(50));
  Binary* expr2 =
      new Binary(new Literal(200), Token(TokenType::MINUS), new Literal(150));
  Binary* expr3 =
      new Binary(new Literal(500), Token(TokenType::MINUS), new Literal(300));
...
TEST(InterpreterTest, SubtractsNegativeNumbers) {
  Interpreter interpreter;
  Binary* expr1 =
      new Binary(new Literal(-5), Token(TokenType::MINUS), new Literal(-1));
  Binary* expr2 =
      new Binary(new Literal(-10), Token(TokenType::MINUS), new Literal(-5));
  Binary* expr3 =
      new Binary(new Literal(-20), Token(TokenType::MINUS), new Literal(-10));
...
TEST(InterpreterTest, SubtractsPositiveAndNegativeNumbers) {
  Interpreter interpreter;
  Binary* expr1 =
      new Binary(new Literal(50), Token(TokenType::MINUS), new Literal(-50));
  Binary* expr2 =
      new Binary(new Literal(-30), Token(TokenType::MINUS), new Literal(20));
  Binary* expr3 =
      new Binary(new Literal(10), Token(TokenType::MINUS), new Literal(-10));
  ...
  Binary* expr4 =
      new Binary(new Literal(-10), Token(TokenType::MINUS), new Literal(10));
  Binary* expr5 =
      new Binary(new Literal(-5), Token(TokenType::MINUS), new Literal(-15));
  Binary* expr6 =
      new Binary(new Literal(0), Token(TokenType::MINUS), new Literal(20));
