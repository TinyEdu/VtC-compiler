...
TEST(InterpreterTest, DividesPositiveNumbers) {
  ...
  Binary* expr1 =
      new Binary(new Literal(6), Token(TokenType::SLASH), new Literal(3));
  Binary* expr2 =
      new Binary(new Literal(100), Token(TokenType::SLASH), new Literal(10));
  Binary* expr3 =
      new Binary(new Literal(25), Token(TokenType::SLASH), new Literal(5));
...
TEST(InterpreterTest, DivisionByZero) {
  Interpreter interpreter;
  Binary* expr1 =
      new Binary(new Literal(6), Token(TokenType::SLASH), new Literal(0));
  Binary* expr2 =
      new Binary(new Literal(-10), Token(TokenType::SLASH), new Literal(0));
