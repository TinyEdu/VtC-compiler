...
TEST(InterpreterTest, MultipliesPositiveNumbers) {
  ...
  Binary* expr1 =
      new Binary(new Literal(2), Token(TokenType::STAR), new Literal(3));
  Binary* expr2 =
      new Binary(new Literal(10), Token(TokenType::STAR), new Literal(20));
  Binary* expr3 =
      new Binary(new Literal(5), Token(TokenType::STAR), new Literal(5));
...
TEST(InterpreterTest, MultipliesPositiveAndNegativeNumbers) {
  Interpreter interpreter;
  Binary* expr1 =
      new Binary(new Literal(3), Token(TokenType::STAR), new Literal(-4));
  Binary* expr2 =
      new Binary(new Literal(-7), Token(TokenType::STAR), new Literal(6));
  Binary* expr3 =
      new Binary(new Literal(5), Token(TokenType::STAR), new Literal(-5));
  ...
  Binary* expr4 =
      new Binary(new Literal(-1), Token(TokenType::STAR), new Literal(10));
  Binary* expr5 =
      new Binary(new Literal(0), Token(TokenType::STAR), new Literal(1234));
  Binary* expr6 =
      new Binary(new Literal(1234), Token(TokenType::STAR), new Literal(0));
...
TEST(InterpreterTest, MultipliesWithZero) {
  Interpreter interpreter;
  Binary* expr1 =
      new Binary(new Literal(0), Token(TokenType::STAR), new Literal(100));
  Binary* expr2 =
      new Binary(new Literal(100), Token(TokenType::STAR), new Literal(0));
  Binary* expr3 =
      new Binary(new Literal(0), Token(TokenType::STAR), new Literal(0));
