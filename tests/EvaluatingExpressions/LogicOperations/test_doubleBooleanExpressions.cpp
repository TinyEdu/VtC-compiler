...
TEST(InterpreterTest, BangEqualOperation) {
  ...
  Expression* expr1 =
      new Binary(new Literal(5), Token(TokenType::BANG_EQUAL), new Literal(3));
  Expression* expr2 =
      new Binary(new Literal(5), Token(TokenType::BANG_EQUAL), new Literal(5));
  Expression* expr3 = new Binary(
      new Literal("hello"), Token(TokenType::BANG_EQUAL), new Literal("world"));
  Expression* expr4 = new Binary(
      new Literal(true), Token(TokenType::BANG_EQUAL), new Literal(false));
...
TEST(InterpreterTest, EqualEqualOperation) {
  ...
  Expression* expr1 =
      new Binary(new Literal(5), Token(TokenType::EQUAL_EQUAL), new Literal(3));
  Expression* expr2 =
      new Binary(new Literal(5), Token(TokenType::EQUAL_EQUAL), new Literal(5));
  Expression* expr3 =
      new Binary(new Literal("hello"), Token(TokenType::EQUAL_EQUAL),
                 new Literal("hello"));
  Expression* expr4 = new Binary(
      new Literal(false), Token(TokenType::EQUAL_EQUAL), new Literal(false));
...
TEST(InterpreterTest, GreaterEqualOperation) {
  ...
  Expression* expr1 = new Binary(
      new Literal(5), Token(TokenType::GREATER_EQUAL), new Literal(3));
  Expression* expr2 = new Binary(
      new Literal(5), Token(TokenType::GREATER_EQUAL), new Literal(5));
  Expression* expr3 = new Binary(
      new Literal(3), Token(TokenType::GREATER_EQUAL), new Literal(5));
...
TEST(InterpreterTest, LessEqualOperation) {
  ...
  Expression* expr1 =
      new Binary(new Literal(3), Token(TokenType::LESS_EQUAL), new Literal(5));
  Expression* expr2 =
      new Binary(new Literal(5), Token(TokenType::LESS_EQUAL), new Literal(5));
  Expression* expr3 =
      new Binary(new Literal(7), Token(TokenType::LESS_EQUAL), new Literal(5));
