...
TEST(InterpreterTest, GreaterOperator) {
  ...
  Expression* expr1 =
      new Binary(new Literal(5), Token(TokenType::GREATER), new Literal(3));
  Expression* expr2 =
      new Binary(new Literal(3), Token(TokenType::GREATER), new Literal(5));
  Expression* expr3 =
      new Binary(new Literal(5), Token(TokenType::GREATER), new Literal(5));
...
TEST(InterpreterTest, LessOperator) {
  ...
  Expression* expr1 =
      new Binary(new Literal(3), Token(TokenType::LESS), new Literal(5));
  Expression* expr2 =
      new Binary(new Literal(5), Token(TokenType::LESS), new Literal(3));
  Expression* expr3 =
      new Binary(new Literal(5), Token(TokenType::LESS), new Literal(5));
